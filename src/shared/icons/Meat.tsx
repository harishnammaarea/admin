...
export default function MeatIcon({ className, fontSize = "1.6rem", rotate = 0, color = "#000000" }: IconTypes) {
  return (
    <svg
      fill={color}
      version="1.1"
      ...
      viewBox="0 0 168 260"
      xmlSpace="preserve">
      <path fill={color} d="M23.9,188.7c8.1,0.3,16.2,0.9,23.9,3.4c21.5,7.2,31.2,31,52.9,38c5,1.6,10,2.3,14.9,2.3c27.4,0,51.7-23.3,50.4-52.4
