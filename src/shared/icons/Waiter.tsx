...
export default function WaiterIcon({ className, color = "#000000", fontSize = "1.6rem", rotate = 0 }: IconTypes) {
  return (
    <svg
      fill="#000000"
      width="800px"
