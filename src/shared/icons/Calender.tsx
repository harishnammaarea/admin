...
export default function CalenderIcon({ className, rotate = 0, fontSize = "1.6rem", color = "000000", }: IconTypes) {
  return (
    <svg
      fill={color}
      className={className}
      ...
      width="800px" height="800px" viewBox="0 0 100 100" enableBackground="new 0 0 100 100" xmlSpace="preserve">
